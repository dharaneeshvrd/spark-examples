...
sqlc = SQLContext(sc)
gpay = sc.textFile('hdfs://jana-hadoop-mgr-1:8020/tmp/OP_DTL_GNRL_PGYR2017_P06292018_edited_for_spark.csv')
...
gpay_df.write.parquet('hdfs://jana-hadoop-mgr-1:8020/tmp/parq_out')
