...
gpay = sc.textFile('/tmp/spark_poc/OP_DTL_RSRCH_PGYR2017_P06292018_edited_for_spark.csv', sc.defaultParallelism)
...
gpay_df.write.parquet('/tmp/spark_poc/parq_out_rsrch')
