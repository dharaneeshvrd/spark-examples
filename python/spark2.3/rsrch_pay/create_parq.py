...
gpay = sc.textFile('/tmp/OP_DTL_RSRCH_PGYR2017_P06292018_edited_for_spark.csv', sc.defaultParallelism)
...
st = time.time()
gpay_df.write.parquet('hdfs://jana-hadoop-mgr-1:8020/tmp/parq_out_rsrch')
et = time.time()
